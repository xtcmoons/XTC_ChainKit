...
- (UILabel *(^)(NSInteger))xtc_numberOfLines {
...
- (UILabel *(^)(NSTextAlignment))xtc_textAlignment {
...
- (UILabel *(^)(NSLineBreakMode))xtc_lineBreakMode {
...
- (UILabel *(^)(UIColor *))xtc_highlightedTextColor {
...
- (UILabel *(^)(UIColor *))xtc_shadowColor {
...
- (UILabel *(^)(CGFloat, CGFloat))xtc_shadowOffset {
...
- (UILabel *(^)(CGFloat))xtc_systemFontOfSize {
...
- (UILabel *(^)(CGFloat))xtc_boldSystemFontOfSize {
    return ^id(CGFloat fontSize) {
